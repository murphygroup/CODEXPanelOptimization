...
from fnet.transforms import normalize, normalize2, normalize3   # normalize for large/small intestine; normalize2 for lymph node, spleen; normalize3 for basel breast cancer dataset
import pandas as pd
