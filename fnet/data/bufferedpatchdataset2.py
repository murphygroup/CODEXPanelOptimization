...
class BufferedPatchDataset2(FnetDataset):
    ...
    def get_random_patch(self):
        ...
        while not generate_new_patch:
            ...
            print(patch_Hochest.detach().numpy().min(), patch_Hochest.detach().numpy().max())
            # imwrite("/home/huangqis/small_intestine_images/test_patch/"+str(sum_intensity) + ".tiff", patch_Hochest.detach().numpy())
